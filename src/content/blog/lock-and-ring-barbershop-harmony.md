---
title: 'The Chord That Grows Larger Than the Singers'
subtitle: 'Understanding Lock and Ring — The Acoustic Magic at the Heart of Barbershop Harmony'
description: 'Lock and ring is a real acoustic phenomenon where barbershop chords produce expanded sound through overtone alignment and just intonation. Learn the physics behind this extraordinary vocal experience.'
pubDate: '2026-03-08'
author: 'Ted Chamberlain'
heroImage: '/images/blog/lock-and-ring-hero.png'
heroImageAlt: 'Visual representation of lock and ring — the expanded acoustic phenomenon in barbershop harmony'
categories: ['Technique', 'Music & Community']
tags: ['lock and ring', 'barbershop harmony', 'overtones', 'just intonation', 'vocal resonance', 'expanded sound', 'acoustic physics', 'barbershop quartet', 'vocal technique', 'harmonic series']
draft: false
---
...
*Ted is the founder of [Ted's Voice Academy](/) and creator of the [Intonation Lab](/intonation-lab) app, specializing in vocal production, just intonation, and the acoustic science behind resonant harmony. He has spent forty-five years as a performer, teacher, and student of the extraordinary things that happen when voices truly align.*
